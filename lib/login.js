...
function update(data, socket)
{
  ...
  if ((message['teamName'] != undefined) && (message['teamName'] != ''))
  {
    ...
    {console.log('Line 176: ' + game.rooms[index]['teams'][index2]['teamName']);
      ...
      if ((!game.rooms[index]['teams'][index2]['full']) && (flag == -1))
      {
      ...
      {
        if (flag != -1)
        {console.log(game.rooms[index]['teams'][index2]['users'][flag]['userName'] + ' ' + game.rooms[index]['teams'][index2]['users'][flag]['userSurname'] + ' reconectado.');console.log('Usuarios: ' + game.rooms[index]['teams'][index2]['users'].length);
          game.rooms[index]['teams'][index2]['users'][flag]['connected'] = true;
          updateSocketId(socket.id, game.rooms[index]['teams'][index2]['users'][flag]['userName'], game.rooms[index]['teams'][index2]['users'][flag]['userSurname'], index);
        }
      }
    }
