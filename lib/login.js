...
function update(data, socket)
{
  ...
  if ((message['teamName'] != undefined) && (message['teamName'] != ''))
  {
    ...
    if ((index2 != -1) && (!game.rooms[index]['teams'][index2]['full']))
    {
      ...
      message['scoreArea1'] = game.rooms[index]['teams'][index2]['scoreArea1'];
      message['scoreArea2'] = game.rooms[index]['teams'][index2]['scoreArea2'];
      message['scoreArea3'] = game.rooms[index]['teams'][index2]['scoreArea3'];
